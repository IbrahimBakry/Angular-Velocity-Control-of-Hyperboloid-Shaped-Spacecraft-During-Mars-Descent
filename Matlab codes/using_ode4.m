...
mzn0 = -0.01; my0f = 0.1; mz0f = 0.1; 
Cx1 = 0.9; Cy1 = 0.9; mz1 = -0.1; 
dzdash = 0.1; dydash = 0.1;
mxw = 0.01; Ixyd = 0.1; Ixzd = 0.1;
...
%         yticklabels({'-0.04' '-0.03' '-0.02' '-0.01' '0'})
        %         axis([0 300 -0.1 0])  
        ax.YLim = [-0.09 0]; % ax.YLim = [-0.025 0];
        ax.XLim = [0.00 100];
figure(4); % Uwx
...
figure(120);    % Ualphaz    
        ...
        ax = gca; ax.GridLineStyle = ':'; ax.GridAlpha = 0.7; ax.FontSize = 20; ax.FontWeight= 'bold'; ax.LineWidth = 0.8; 
        ax.XLim = [0 50];
        ax.YLim = [-0.09 0]; % -0.007 -0.025 -0.07
        hold off;
        ax.XAxis.LineWidth = 4; 
...
figure(121); % Uwxz
        ...
        grid on; box on; xlabel('t, c'); ylabel('Функция управления U_\omega, 1/c^2');
        ax = gca; ax.GridLineStyle = ':'; ax.GridAlpha = 0.7; ax.FontSize = 20; ax.FontWeight= 'bold'; ax.LineWidth = 0.8; 
        ax.YLim = [-0.03 0]; % -0.005 -0.015 -0.05
        ax.XLim = [0 50];
        hold off;
        ax.XAxis.LineWidth = 4; 
        ax.YAxis.LineWidth = 4;
